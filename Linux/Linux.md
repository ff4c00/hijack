...
- [2. 终端](#2-终端)
  - [2.1. 常用快捷键](#21-常用快捷键)
- [3. 备份](#3-备份)
  - [3.1. tar 打包命令](#31-tar-打包命令)
  - [3.2. rsync-数据镜像备份](#32-rsync-数据镜像备份)
  - [3.3. pigz](#33-pigz)
- [4. 常用软件](#4-常用软件)
  - [4.1. Unity Tweak Tool](#41-unity-tweak-tool)
    - [4.1.1. 菜单栏消失](#411-菜单栏消失)
  - [4.2. indicator-stickynotes](#42-indicator-stickynotes)
